...
- `/corporate-actions`
- `/admin/**`
- `/admin/participants/dormant` (탈퇴 자동 참여자의 휴면 계좌·현금·보유주식·예약·전략 원장)
...
- 휴면 자산 화면은 `WITHDRAWN` 생명주기 범위만 읽고 자동 폴링하지 않습니다. 보유주식·현금과 함께 탈퇴 후 남은 미체결 주문·매도 예약·활성 예산을 운영 점검 신호로 구분합니다.
