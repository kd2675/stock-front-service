...
function OrderBookRow({
  ...
  return (
    ...
    >
      ...
      <span className={`relative z-20 min-w-0 truncate font-black tabular-nums ${level ? textColor : "text-[#b0b8c1]"}`} title={level ? formatRoundedPrice(level.price) : undefined}>
