...
function StackedOrderBookRow({
  ...
  return (
    ...
    >
      ...
      <span className={`relative z-20 min-w-0 truncate text-center font-black tabular-nums ${level ? priceColor : "text-[#b0b8c1]"}`} title={level ? formatRoundedPrice(level.price) : undefined}>
