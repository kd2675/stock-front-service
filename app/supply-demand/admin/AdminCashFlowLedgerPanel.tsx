    ...
    <section className="admin-panel mt-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs font-bold text-stock-subtle">유저와 자동참여자 계좌의 입금, 회수, 월급, 배당 현금 흐름을 페이지 단위로 조회합니다.</p>
        </div>
      ...
      <DataTableViewport label="전체 현금 원장" tone="dark" className="mt-4">
