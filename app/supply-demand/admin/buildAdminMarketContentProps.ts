...
export function buildAdminMarketContentProps({
  ...
  return {
    ...
    flowOverviewError: adminFlowOverviewQuery.isError,
    instruments,
    ...
    marketIndex: adminMarketIndexQuery.data ?? null,
    marketIndexError: adminMarketIndexQuery.isError,
    marketIndexLoading: adminMarketIndexQuery.isFetching && !adminMarketIndexQuery.data,
    jumpingSimulationClockAction,
    ...
    loadingSymbolFlows: adminFlowOverviewQuery.isFetching,
    ...
    symbolFlowList: {
      simulationTradeDate: adminFlowOverview?.simulationTradeDate ?? null,
      rangeStart: adminFlowOverview?.rangeStart ?? null,
      rangeEnd: adminFlowOverview?.rangeEnd ?? null,
      sourceStatus: adminFlowOverview?.symbolFlowSourceStatus ?? null,
      sourceUpdatedAt: adminFlowOverview?.symbolFlowSourceUpdatedAt ?? null,
