      ...
      <table className="min-w-[980px] w-full border-collapse text-sm">
        ...
        <tbody className="divide-y divide-white/10">
                ...
                <tr>
                  ...
                  <td className="px-4 py-3">
                    <button
                      ...
                      className="rounded-md border border-white/10 bg-white/[0.06] px-3 py-2 text-xs font-black text-[#d8ecff] transition hover:border-[#64a8ff]/60 disabled:cursor-wait disabled:opacity-50"
                    >
                      ...
                      <div className="grid gap-3 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
                        ...
                        <div className="flex min-w-0 gap-2">
                          <button
                            ...
                            disabled={isUpdatingRules}
                            className="h-11 rounded-md bg-[#3182f6] px-4 text-sm font-black text-white transition hover:bg-[#1b64da] disabled:cursor-wait disabled:opacity-50"
                          >
                            저장
                          </button>
                          <button
                            ...
                            disabled={isUpdatingRules}
                            className="h-11 rounded-md border border-white/10 px-4 text-sm font-black text-[#b8c2cc] transition hover:border-white/20 disabled:cursor-wait disabled:opacity-50"
                          >
                            취소
                          </button>
                        </div>
          ...
          {instruments.length === 0 ? (
            <tr>
              <td colSpan={9} className="px-4 py-5 text-[#8b95a1]">아직 생성된 수요와 공급 종목이 없습니다.</td>
            </tr>
          ) : null}
        </tbody>
      </table>
