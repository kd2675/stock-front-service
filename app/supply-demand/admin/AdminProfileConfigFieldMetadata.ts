...
export const PROFILE_CONFIG_BEHAVIOR_FIELDS = [
  ...
  { key: "orderMultiplier", setterKey: "setOrderMultiplier", formLabel: "주문 빈도(0-5)", summaryLabel: "주문 빈도", placeholder: "1", min: 0, max: 5, defaultValue: DEFAULT_PROFILE_MULTIPLIER, suffix: "배" },
  ...
  { key: "quantityMultiplier", setterKey: "setQuantityMultiplier", formLabel: "수량 배율(0-5)", summaryLabel: "수량", placeholder: "1", min: 0, max: 5, defaultValue: DEFAULT_PROFILE_MULTIPLIER, suffix: "배" },
