    ...
    <>
      ...
      <p className="mt-2 text-xs font-bold text-stock-subtle">
        {isDividendReinvestorProfileSelected
          ...
          : "심리 행동 가중치는 0-1 사이이며 실제 매수/매도 판단 방향에 직접 들어갑니다. 주문 빈도, 호가 공격성, TTL, 수량은 행동 결과의 빈도와 크기를 조정합니다. 기본 EOD 모드의 주기 입금은 00시 이후 거래일당 한 번만 도래 여부를 확인하고 누락 회차를 소급 지급하지 않습니다."}
      </p>
    </>
  );
}
