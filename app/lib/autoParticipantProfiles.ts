...
export const AUTO_PARTICIPANT_PROFILE_OPTIONS: AutoParticipantProfileOption[] = [
  { value: "NEWS_REACTIVE", label: "뉴스 민감형", description: "보고서 점수에 크게 반응", behavior: "최신 종목 평가 점수의 방향을 강하게 반영합니다. 보고서는 주문 활동 강도를 바꾸지 않으며, 첫 반응은 호재 매수/악재 매도지만 후속 주문은 보유, 현금, 수익률을 다시 섞어 판단합니다." },
  ...
  { value: "MARKET_MAKER", label: "시장조성형", description: "재고와 스프레드 중심으로 호가 공급", behavior: "주식 평가액이 현금+주식의 40%보다 낮으면 매수, 60%보다 높으면 매도를 우선하고 40~60% 재고 밴드 안에서는 양방향 호가를 번갈아 공급합니다." },
  ...
  { value: "DIVIDEND_REINVESTOR", label: "배당재투자형", description: "배당 지급 후 받은 현금을 재매수에 사용", behavior: "정기 자금 지급 대상이 아니며, 배당 이벤트로 현금이 들어온 뒤 장기 보유 성향을 유지하면서 재매수 쪽으로 움직입니다." },
  ...
  { value: "STOP_LOSS_TRADER", label: "칼손절형", description: "손실 임계값에서 빠르게 매도", behavior: "평균단가 대비 -5% 이하이거나 하락 모멘텀이 매우 강하면 매도를 우선합니다. -5% 미만의 작은 손실에서는 반복 손절을 막기 위해 주문을 쉽니다." },
  ...
  { value: "DIP_BUYER", label: "저점매수형", description: "시장 급락 후 반등 기회를 탐색", behavior: "종목의 단기 하락 모멘텀이 강할 때 첫 주문을 매수로 냅니다. 개인 평균단가 손실만으로 강제 매수하지 않아 물타기형과 구분합니다." },
