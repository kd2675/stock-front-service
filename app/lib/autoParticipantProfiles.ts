...
export const AUTO_PARTICIPANT_PROFILE_OPTIONS: AutoParticipantProfileOption[] = [
  ...
  { value: "PAYDAY_ACCUMULATOR", label: "월급매수형", description: "설정한 입금 주기마다 현금 유입 후 꾸준히 매수", behavior: "설정 주기마다 자동 입금 원장을 만들고 첫 반응은 매수 편향을 유지하지만, 수익이 커진 보유분은 후속 주문에서 일부 익절할 수 있습니다." },
