...
export const AUTO_PARTICIPANT_PROFILE_OPTIONS: AutoParticipantProfileOption[] = [
  ...
  { value: "MARKET_MAKER", label: "시장조성형", description: "포트폴리오 재고와 스프레드 중심으로 양방향 공급", behavior: "전체 유동자산의 주식 목표 50%를 예상 보유 종목 수로 나눈 종목별 목표와 ±20% 밴드를 사용합니다. 밴드 안에서는 교차하지 않는 매수·매도 호가를 쌍으로 공급하고, 밴드 밖에서는 재고를 목표로 되돌리는 한쪽만 주문합니다." },
